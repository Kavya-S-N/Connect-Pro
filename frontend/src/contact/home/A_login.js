...
onSubmit = async (e) => {
   ...
   try {
    ...
    render() {
      ...
      return (
         <Fragment>
            {this.state.isAuth ? (<Redirect isAuth={this.state.isAuth} to="/admin/admin_dash" />
            ): (
               ...
               <form method="post" onSubmit={this.onSubmit}>
                  <div><br/><br/>
                      <div className="card card-header mx-auto col-md-4"> 
                          ...
                          {/* <p className="mx-auto"> Don't have an account?<Link to="/company_registration">Sign Up</Link></p> */}
