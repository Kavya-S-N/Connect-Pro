...
// "name":"","email":"","phone":"","dob":"","gender":"","college":"","department":"","address":""
...
StudentSchema.pre("remove", async function (next) {
  console.log(`Project being removed from Student ${this._id}`);
  await this.model("Projects").deleteMany({ student: this._id });
  next();
});
